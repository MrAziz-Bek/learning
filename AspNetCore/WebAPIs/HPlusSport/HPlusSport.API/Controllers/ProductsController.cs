...
public class ProductsV1Controller : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<Product>>> GetAllProducts([FromQuery] ProductQueryParameters queryParameters) // query may be like "?size=N&page=M". N and M are numbers
    {
    ...
    [HttpPost]
    [Route("Delete")]
    public async Task<ActionResult> DeleteMultiple([FromQuery] int[] ids) // query may be like "delete?ids=1&ids=2&ids=3&...&ids=n"
    {
